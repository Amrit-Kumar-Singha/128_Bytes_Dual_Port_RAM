...
# Generated on: Fri Jul 19 15:39:18 IST 2024 (Fri Jul 19 10:09:18 UTC 2024)
...
set_log_file fv/Ram_dualport/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/Ram_dualport -revised fv_map
...
add_search_path /home/cadence/Desktop/sram/dual_port_ram -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/cadence/Desktop/sram/dual_port_ram/Ram_dualport.v
elaborate_design -golden -root {Ram_dualport} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/Ram_dualport/fv_map.v.gz
elaborate_design -revised -root {Ram_dualport}
...
#add_name_alias fv/Ram_dualport/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/Ram_dualport/rtl_to_fv_map.log
}
